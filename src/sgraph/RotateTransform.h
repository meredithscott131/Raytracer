 ...
 */
    class RotateTransform: public TransformNode {
        ...
        public:
            RotateTransform(float angleInRadians,float ax,float ay,float az,const string& name,sgraph::IScenegraph *graph,vector<util::Light>& lights) 
                :TransformNode(name,graph,lights) {
